...
Do not include any title, header, or overview text - just write the article content directly.
Do not start with "Overview of Current Online Discourse" or any similar header.`
        },
        {
          role: 'user',
